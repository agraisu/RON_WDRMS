...
<html>
    ...
    <body>
        <table border="" style="width: 100%; font-weight: bold;" class="tbl_boder displayHide center">
            <thead>
                <tr>
                    <th><a href="./?x=cus_req_status"><button type="button" style="background-color: #D9EDF7; width: 3cm; height: 1cm;" ><b>Back</b></button></a></th>
...
<!--                    <p>
                    ...
                    <p>
                        <b style="margin-bottom:1px">Custom Request Receipt</b>
                    </p>
                </div>
                <div class="info" style="text-align: left; margin-top:-5;">
                    <table>
                        <tr>
                            <td>Receipt : #<?php echo $req_no; ?> </td>
                        </tr>
                        <tr>
            ...
            <div id="bot">
                ...
                <div id="table">
                    <table>
                        ...
                        <tr class="service">
                            <td class="tableitem" colspan="4"><p class="itemtext" style=""><?php echo nl2br($result[0]['cus_req_note']); ?></p></td>
                        ...
                        <tr><td colspan="5" style="text-align: right; border-top-style: solid; border-bottom: double">Advance Amount : <?php echo number_format((float) $result[0]['cus_req_advance'], 2, '.', ''); ?></td></tr> 
                        <tr><td colspan="5" style="text-align: right; border-top-style: solid; border-bottom: double">Balance Amount : <?php echo number_format((float) $result[0]['cus_req_balance'], 2, '.', ''); ?></td></tr> 
