        ...
        <form method="post" action="">
                ...
                <thead>
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <span style="font-size: 15px;">Summary of the Customers</span><br>
            ...
            <table class="center" border="1" style="width: 100%; font-size: 13pt; font-weight: bold;background-color: white" class="tbl_boder">
                <tr>
                    ...
                    <th style="width: 10cm;">Customer Name</th>
                    <th style="width: 10cm;">NIC</th>
                    <th style="width: 8cm;">Email</th>
                    <th style="width: 8cm;">Contact</th>
                    <th style="width: 8cm;">Address</th>
...
customer_details.cus_status = 1";
                    ...
                    foreach ($result2 AS $aa) {
                        echo '<tr>'
                        . '<td>' . $no . '</td>'
                        . '<td>' . $aa['cus_regi_no'] . '</td>'
                        . '<td>' . $aa['cus_name'] . '</td>'
                        . '<td>' . $aa['cus_nic'] . '</td>'
                        . '<td>' . $aa['cus_email'] . '</td>'
                        . '<td>' . $aa['cus_contact'] . '</td>'
                        . '<td>' . $aa['cus_address'] . '</td>'
                        . '<td>' . $aa['cus_regi_date'] . '</td>'
                        . '<td></td>'
                        . '</tr>';
                        $rowCount++;
                        if ($page_no == 1) {
