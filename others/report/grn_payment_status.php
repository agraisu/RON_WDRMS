                    ...
                    <tr>
                        ...
                        <th>
                            <select class="form-control" name="type">
                                ...
                                <option value="2">Settled Payments</option>
                                <option value="3">Pending Payments</option>
                            </select>
                        </th>
                    </tr>
                    <tr>
                ...
                <thead>
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <span style="font-size: 15px;">GRN Payment Status</span><br>
                ...
                if (isset($_POST['gen_report'])) {
                    ...
                    if ($_POST['type'] == 1) {
                        ...
                        $query = "SELECT
                               ...
                               grn_details.balance_amount = 0.00";
                    } else {
                        $query = "SELECT
                               grn_details.grn_no,
                               grn_details.grn_date,
